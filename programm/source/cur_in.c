...
//-----------------------------------------------------------------------------
void TCurIn :: adc_init()
{
    // 000000000000  1    0       0        0      0       0          00     00   00100 00001
    // Reserved    ADCEN Bipol NegBUFen PosBUFen PosBUFbp NegBUFbp INTREF CurOff AIN4+ AIN1-
    pADI_ADC1->CON = 0x00080081;
    pADI_ADC1->FLT = 0xc07d;
    // 00000000  0000    0     001
    //    res    PGA  ADCMOD2 CONT
 //   pADI_ADC1->MDE = 0x0049;        //gain 32 ±37.5 mV
    pADI_ADC1->MDE = 0x0011;        //±500 mV
...
//-----------------------------------------------------------------------------
void TCurIn::cycle_func()
{
    if (is_ready_adc_conv())
    {
        value = mV / R_SENS;        //value в мА
    }
}
