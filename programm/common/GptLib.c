...
/**
	...
	@param iTCapSrc :{T0CON_EVENT_T2, T0CON_EVENT_EXT0, T0CON_EVENT_EXT1, T0CON_EVENT_EXT2, 
                               ...
                               T0CON_EVENT_EXT7, T0CON_EVENT_T3, T0CON_EVENT_T0, T0CON_EVENT_T1,
                               T0CON_EVENT_ADC0, T0CON_EVENT_ADC1, T0CON_EVENT_SINC2,
							   T1CON_EVENT_Flash, T1CON_EVENT_COM, T1CON_EVENT_SPI0, T1CON_EVENT_SPI1,
							   T1CON_EVENT_I2CS, T1CON_EVENT_I2CM, T1CON_EVENT_DMAERR, T1CON_EVENT_DMASPI1TX,
							   T1CON_EVENT_DMASPI1RX, T1CON_EVENT_DMACOMTX, T1CON_EVENT_DMACOMRX,
							   T1CON_EVENT_DMAI2CSTX, T1CON_EVENT_DMAI2CSRX, T1CON_EVENT_DMAI2CMTX,
							   T1CON_EVENT_DMAI2CMRX, T1CON_EVENT_DMADAC }
		- TxCON.8-11
                ...
                - for timer 1  capture event, select one of the following event: 
							   T1CON_EVENT_FEE, T1CON_EVENT_COM, T1CON_EVENT_SPI0, T1CON_EVENT_SPI1,
							   T1CON_EVENT_I2CS, T1CON_EVENT_I2CM, T1CON_EVENT_DMAERR, T1CON_EVENT_DMASPI1TX,
							   T1CON_EVENT_DMASPI1RX, T1CON_EVENT_DMACOMTX, T1CON_EVENT_DMACOMRX,
							   T1CON_EVENT_DMAI2CSTX, T1CON_EVENT_DMAI2CSRX, T1CON_EVENT_DMAI2CMTX,
							   T1CON_EVENT_DMAI2CMRX, T1CON_EVENT_DMADAC   
...
{
  //if(pTMR->STA & TSTA_BUSY) return 1;
  //else return 0;
  if (pTMR == pADI_TM0) return T1STA_CON_BBA;
